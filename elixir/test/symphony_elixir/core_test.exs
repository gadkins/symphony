defmodule SymphonyElixir.CoreTest do
  ...
  test "normal worker exit schedules active-state continuation retry" do
    ...
    event_sent_at_ms = System.monotonic_time(:millisecond)
    ...
    assert_due_in_range(due_at_ms, event_sent_at_ms, 500, 1_100)
  end
  ...
  test "abnormal worker exit increments retry attempt progressively" do
    ...
    assert_due_in_range(due_at_ms, event_sent_at_ms, 39_500, 40_500)
  end
  ...
  test "first abnormal worker exit waits before retrying" do
    ...
    assert_due_in_range(due_at_ms, event_sent_at_ms, 9_000, 10_500)
  end
  ...
  defp assert_due_in_range(due_at_ms, event_sent_at_ms, min_delay_ms, max_delay_ms) do
    scheduled_delay_ms = due_at_ms - event_sent_at_ms
